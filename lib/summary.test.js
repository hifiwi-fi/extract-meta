...
function testHtml (file, url, result, option = 'test') {
  ...
  test(`testing ${file} summary extraction`, testOptions, async (_t) => {
    ...
    assert.strictEqual(summary, result)
  })
}
...
testHtml('cable-lacing', 'https://www.thebroadcastbridge.com/content/entry/12400/the-lost-art-of-lacing-cable', 'Once, while visiting NBC Television studios in Manhattan’s 30 Rockefeller Center, I saw an abandoned elevator shaft with seemingly miles of different cables laced together. I took notice because it was a such a rare sight — with the maze of work quite intricate and, in a way, beautiful.')
